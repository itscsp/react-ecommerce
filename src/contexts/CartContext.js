...
const CartProvider = ({children}) => {
  ...
  return <CartContext.Provider value={{cart, wish, addToCart, removeFromCart, clearCart, increaseAmount, decreseAmount, itemAmount, totalAmount, wishHandler}}>{children}</CartContext.Provider>;
};
